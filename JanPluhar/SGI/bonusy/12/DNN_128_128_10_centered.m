...
test_data(i,:,:)=centerImage(squeeze(test_data(i,:,:)));
end
...
load digits_tren;
for j=1:length(tren_data)
tren_data(j,:,:)=centerImage(squeeze(tren_data(j,:,:)));
end
